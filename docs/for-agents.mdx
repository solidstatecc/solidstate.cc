...
```
https://solidstate.cc/.well-known/agent-skills/index.json   # Discovery spec v0.2.0 — $schema, digests
https://solidstate.cc/.well-known/skills/index.json         # legacy v0.1.0 — Hermes-compatible
```
